...
/**
 * min - this function always returns the minimum of two size_t values
 * @a: param, first value
 ...
 * (integer) using an exponential search algorithm
 * @array: param, pointer to first element of array to search
 * @size: param, int, number of elements in array
 * @value: param, value to search for
 * Return: value, first index containing, else  -1
 */
